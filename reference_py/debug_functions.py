## To run: python reference_py/debug_functions.py
import sys
...
DEBUG_DIR = DATA_DIR / "test_data" / "debug_images"
DEBUG_DIR.mkdir(exist_ok=True)

from reference_py.preprocessing import load_grayscale_image, gaussian_filter, otsu_threshold
from reference_py.cleaning_and_boundary_extraction import (
    erode,
    dilate,
    morphological_open,
...
from reference_py.contour_to_signal import (
